...
import {
    deleteBatchSysData,
    deleteSysData,
    exportChoseExcelSysData,
    exportExcelSysData,
    exportParamExcelSysData,
    exportTemplateSysData,
    queryPageSysData,
    saveBatchSysData,
    saveSysData,
    selectSysData,
} from "@/api/sys-data-api";
        ...
        return {
            ...
            filterData: {
                ...
                inputs: [
                    {
                        key: 'platId',
                        length: 11,
                        name: i18n.t('view.sysData.platId'),
                    },
                    {
                        key: 'name',
                        length: 10,
                        name: i18n.t('view.sysData.name'),
                    },
                    {
                        key: 'code',
                        length: 50,
                        name: i18n.t('view.sysData.code'),
                    },
                    {
                        key: 'value',
                        length: 50,
                        name: i18n.t('view.sysData.value'),
                    },
                ],
                // 搜索下拉框
                selects: [
                    {
                        key: 'creUserName',
                        name: i18n.t('view.sysData.creUserName'),
                        dataSelect: {
                            url: 'sys-user',
                        }
                    },
                    {
                        key: 'updUserName',
                        name: i18n.t('view.sysData.updUserName'),
                        dataSelect: {
                            url: 'sys-user',
                        }
                    },
                ...
                dateTimePickers: [
                    {
                        key: 'creTime',
                        name: i18n.t('view.sysData.creTime'),
                    },
                    {
                        key: 'updTime',
                        name: i18n.t('view.sysData.updTime'),
                    },
                ],
            },
            ...
            dataSource: {
                ...
                columns: [
                    {
                        key: 'id',
                        label: i18n.t('view.sysData.id'),
                        sortable: true,
                    },
                    {
                        key: 'platId',
                        label: i18n.t('view.sysData.platId'),
                        sortable: true,
                    },
                    {
                        key: 'name',
                        label: i18n.t('view.sysData.name'),
                        sortable: true,
                    },
                    {
                        key: 'code',
                        label: i18n.t('view.sysData.code'),
                        sortable: true,
                    },
                    {
                        key: 'value',
                        label: i18n.t('view.sysData.value'),
                        sortable: true,
                    },
                    {
                        key: 'creUserName',
                        label: i18n.t('view.sysData.creUserName'),
                        sortable: true,
                    },
                    {
                        width: 160,
                        key: 'creTime',
                        label: i18n.t('view.sysData.creTime'),
                        sortable: true,
                    },
                    {
                        key: 'updUserName',
                        label: i18n.t('view.sysData.updUserName'),
                        sortable: true,
                    },
                    {
                        width: 160,
                        key: 'updTime',
                        label: i18n.t('view.sysData.updTime'),
                        sortable: true,
                    },
                ],
                // 表格数据
                    ...
                    data: [
                        {
                            ...
                            handleRowClick: (index, row) => {
                                selectSysData({id: row.id}).then((res) => {
                        ...
                        },
                        {
                            ...
                            handleRowClick: (index, row) => {
                                this.$confirm(i18n.t('common.messageBox.delete.title') + row.name, i18n.t('common.messageBox.tips'), {
                                    ...
                                    // 确定
                                    deleteSysData({id: row.id}).then((res) => {
                                        if (res.data) {
                                            this.queryPage()
    ...
    methods: {
        ...
        async queryPage() {
            ...
            try {
                ...
                const res = await queryPageSysData({ ...pagination, ...sort, ...this.filterData.listQuery });
        ...
        batchAdd() {
            try {
                saveBatchSysData(this.batchDialogData.excelData.file).then((res) => {
                    if (res.data) {
                        this.queryPage();
                        this.$message.success(i18n.t('common.success'));
        ...
        batchDelete() {
            this.$confirm(i18n.t('common.messageBox.batchDelete.title'), i18n.t('common.messageBox.tips'), {
                ...
                // 确定
                deleteBatchSysData(this.selected).then((res) => {
                    if (res.data) {
                        this.queryPage()
                        this.$message.success(i18n.t('common.success'));
                    } else {
        ...
        batchExport(key) {
            ...
            switch (key) {
                ...
                case EXPORT_TYPE.CHOOSE: {
                    ...
                    hasSelected ? exportChoseExcelSysData(this.selected) : this.$message.error(EXPORT_CHOOSE_NULL_ERROR_MSG);
                    break;
                }
                case EXPORT_TYPE.QUERY:
                    this.$message.success(EXPORT_SUCCESS_MSG);
                    exportParamExcelSysData({...this.filterData.listQuery});
                    break;
