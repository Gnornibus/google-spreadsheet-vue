...
import {
    deleteBatchSysPlat,
    deleteSysPlat,
    exportChoseExcelSysPlat,
    exportExcelSysPlat,
    exportParamExcelSysPlat,
    exportTemplateSysPlat,
    queryPageSysPlat,
    saveBatchSysPlat,
    saveSysPlat,
    selectSysPlat,
} from "@/api/sys-plat-api";
        ...
        return {
            ...
            filterData: {
                ...
                selects: [
                    {
                        key: 'rootId',
                        name: i18n.t('view.sysPlat.rootId'),
                        dataSelect: {
                            url: "sys-user"
                        }
                    },
                    {
                        key: 'creUserName',
                        name: i18n.t('view.sysPlat.creUserName'),
                        dataSelect: {
                            url: "sys-user"
                        }
                    },
                    {
                        key: 'updUserName',
                        name: i18n.t('view.sysPlat.updUserName'),
                        dataSelect: {
                            url: "sys-user"
                        }
                    },
                ...
                dateTimePickers: [
                    {
                        key: 'creTime',
                        name: i18n.t('view.sysPlat.creTime'),
                    },
                    {
                        key: 'updTime',
                        name: i18n.t('view.sysPlat.updTime'),
                    },
                ],
            },
            ...
            dataSource: {
                ...
                columns: [
                    {
                        key: 'id',
                        label: i18n.t('view.sysPlat.id'),
                        sortable: true,
                    },
                    {
                        key: 'name',
                        label: i18n.t('view.sysPlat.name'),
                        sortable: true,
                    },
                    {
                        key: 'code',
                        label: i18n.t('view.sysPlat.code'),
                        sortable: true,
                    },
                    {
                        key: 'rootName',
                        label: i18n.t('view.sysPlat.rootName'),
                        sortable: true,
                    },
                    {
                        key: 'creUserName',
                        label: i18n.t('view.sysPlat.creUserName'),
                        sortable: true,
                    },
                    {
                        width: 160,
                        key: 'creTime',
                        label: i18n.t('view.sysPlat.creTime'),
                        sortable: true,
                    },
                    {
                        key: 'updUserName',
                        label: i18n.t('view.sysPlat.updUserName'),
                        sortable: true,
                    },
                    {
                        width: 160,
                        key: 'updTime',
                        label: i18n.t('view.sysPlat.updTime'),
                        sortable: true,
                    },
                ],
                // 表格数据
                    ...
                    data: [
                        {
                            ...
                            handleRowClick: (index, row) => {
                                // 初始化平台负责人下拉框
                                selectSysPlat({id: row.id}).then((res) => {
                        ...
                        },
                        {
                            ...
                            handleRowClick: (index, row) => {
                                this.$confirm(i18n.t('common.messageBox.delete.title') + row.name, i18n.t('common.messageBox.tips'), {
                                    ...
                                    // 确定
                                    deleteSysPlat({id: row.id}).then((res) => {
                                        if (res.data) {
                                            this.queryPage()
    ...
    methods: {
        ...
        async queryPage() {
            ...
            try {
                ...
                const res = await queryPageSysPlat({...pagination, ...sort, ...this.filterData.listQuery});
        ...
        batchAdd() {
            try {
                saveBatchSysPlat(this.batchDialogData.excelData.file).then((res) => {
                    if (res.data) {
                        this.queryPage();
                        this.$message.success(i18n.t('common.success'));
        ...
        batchDelete() {
            this.$confirm(i18n.t('common.messageBox.batchDelete.title'), i18n.t('common.messageBox.tips'), {
                ...
                // 确定
                deleteBatchSysPlat(this.selected).then((res) => {
                    if (res.data) {
                        this.queryPage()
                        this.$message.success(i18n.t('common.success'));
                    } else {
        ...
        batchExport(key) {
            ...
            switch (key) {
                ...
                case EXPORT_TYPE.CHOOSE: {
                    ...
                    hasSelected ? exportChoseExcelSysPlat(this.selected) : this.$message.error(EXPORT_CHOOSE_NULL_ERROR_MSG);
                    break;
                }
                case EXPORT_TYPE.QUERY:
                    this.$message.success(EXPORT_SUCCESS_MSG);
                    exportParamExcelSysPlat({...this.filterData.listQuery});
                    break;
