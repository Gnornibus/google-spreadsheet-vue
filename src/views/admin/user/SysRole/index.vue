...
import {
    deleteBatchSysRole,
    deleteSysRole,
    exportChoseExcelSysRole,
    exportExcelSysRole,
    exportParamExcelSysRole,
    exportTemplateSysRole,
    queryPageSysRole,
    saveBatchSysRole,
    saveSysRole,
    selectSysRole,
} from "@/api/sys-role-api";
import i18n from '@/common/lang';
import UploadExcelComponent from '@/components/UploadExcel/index.vue';
import BackToTop from "@/components/BackToTop";
import {selectAllSysPlatDict, selectAllSysRoleDict} from "@/api/dict-api";
        ...
        return {
            ...
            filterData: {
                ...
                inputs: [
                    ...
                    },
                    {
                        key: 'powers',
                        length: 2000,
                        name: i18n.t('view.sysRole.powers'),
                    },
                    {
                        key: 'checkedKey',
                        length: 2000,
                        name: i18n.t('view.sysRole.checkedKey'),
                    },
                    {
                        key: 'remark',
                        length: 255,
                        name: i18n.t('view.sysRole.remark'),
                    },
                ],
                // 搜索下拉框
                selects: [
                    {
                        key: 'state',
                        name: i18n.t('view.sysRole.state'),
                        dictSelect: {
                    ...
                    {
                        key: 'platId',
                        name: i18n.t('view.sysRole.platId'),
                        dataSelect: {
                            url: "sys-plat"
                        }
                    },
                    {
                        key: 'supRoleId',
                        name: i18n.t('view.sysRole.supRoleId'),
                        dataSelect: {
                            url: "sys-role"
                        }
                    },
                    {
                        key: 'ownerRoleId',
                        name: i18n.t('view.sysRole.ownerRoleId'),
                        dataSelect: {
                            url: "sys-role"
                        }
                    },
                    {
                        key: 'ownCreUserPower',
                        name: i18n.t('view.sysRole.ownCreUserPower'),
                        dataSelect: {
                            url: "sys-role"
                        }
                    },
                    {
                        key: 'creUserId',
                        name: i18n.t('view.sysRole.creUserName'),
                        dataSelect: {
                            url: "sys-user"
                        }
                    },
                    {
                        key: 'updUserId',
                        name: i18n.t('view.sysRole.updUserName'),
                        dataSelect: {
                            url: "sys-user"
                        }
                    },
                ...
                dateTimePickers: [
                    {
                        key: 'creTime',
                        name: i18n.t('view.sysRole.creTime'),
                    },
                    {
                        key: 'updTime',
                        name: i18n.t('view.sysRole.updTime'),
                    },
                ],
            },
            ...
            dataSource: {
                ...
                columns: [
                    {
                        key: 'id',
                        label: i18n.t('view.sysRole.id'),
                        sortable: true,
                    },
                    {
                        key: 'platName',
                        label: i18n.t('view.sysRole.platName'),
                        sortable: true,
                    },
                    {
                        key: 'name',
                        label: i18n.t('view.sysRole.name'),
                        sortable: true,
                    },
                    {
                        key: 'powers',
                        label: i18n.t('view.sysRole.powers'),
                        sortable: true,
                    },
                    {
                        key: 'checkedKey',
                        label: i18n.t('view.sysRole.checkedKey'),
                        sortable: true,
                    },
                    {
                        key: 'ownCreUserPower',
                        label: i18n.t('view.sysRole.ownCreUserPower'),
                        sortable: true,
                    },
                    {
                        key: 'state',
                        label: i18n.t('view.sysRole.state'),
                        sortable: true,
                    ...
                    {
                        key: 'supRoleId',
                        label: i18n.t('view.sysRole.supRoleId'),
                        sortable: true,
                    },
                    {
                        key: 'ownerRoleId',
                        label: i18n.t('view.sysRole.ownerRoleId'),
                        sortable: true,
                    },
                    {
                        key: 'remark',
                        label: i18n.t('view.sysRole.remark'),
                        sortable: true,
                    },
                    {
                        key: 'creUserName',
                        label: i18n.t('view.sysRole.creUserName'),
                        sortable: true,
                    },
                    {
                        width: 160,
                        key: 'creTime',
                        label: i18n.t('view.sysRole.creTime'),
                        sortable: true,
                    },
                    {
                        key: 'updUserName',
                        label: i18n.t('view.sysRole.updUserName'),
                        sortable: true,
                    },
                    {
                        width: 160,
                        key: 'updTime',
                        label: i18n.t('view.sysRole.updTime'),
                        sortable: true,
                    },
                ],
                // 表格数据
                    ...
                    data: [
                        {
                            ...
                            handleRowClick: (index, row) => {
                                selectSysRole({id: row.id}).then((res) => {
                        ...
                        },
                        {
                            ...
                            handleRowClick: (index, row) => {
                                this.$confirm(i18n.t('common.messageBox.delete.title') + row.name, i18n.t('common.messageBox.tips'), {
                                    ...
                                    // 确定
                                    deleteSysRole({id: row.id}).then((res) => {
                                        if (res.data) {
                                            this.queryPage()
    ...
    methods: {
        ...
        async queryPage() {
            ...
            try {
                ...
                const res = await queryPageSysRole({...pagination, ...sort, ...this.filterData.listQuery});
        ...
        batchAdd() {
            try {
                saveBatchSysRole(this.batchDialogData.excelData.file).then((res) => {
                    if (res.data) {
                        this.queryPage();
                        this.$message.success(i18n.t('common.success'));
        ...
        batchDelete() {
            this.$confirm(i18n.t('common.messageBox.batchDelete.title'), i18n.t('common.messageBox.tips'), {
                ...
                // 确定
                deleteBatchSysRole(this.selected).then((res) => {
                    if (res.data) {
                        this.queryPage()
                        this.$message.success(i18n.t('common.success'));
                    } else {
        ...
        batchExport(key) {
            ...
            switch (key) {
                ...
                case EXPORT_TYPE.CHOOSE: {
                    ...
                    hasSelected ? exportChoseExcelSysRole(this.selected) : this.$message.error(EXPORT_CHOOSE_NULL_ERROR_MSG);
                    break;
                }
                case EXPORT_TYPE.QUERY:
                    this.$message.success(EXPORT_SUCCESS_MSG);
                    exportParamExcelSysRole({...this.filterData.listQuery});
                    break;
