...
import {
    deleteBatchSportMemberType,
    deleteSportMemberType,
    exportChoseExcelSportMemberType,
    exportExcelSportMemberType,
    exportParamExcelSportMemberType,
    exportTemplateSportMemberType,
    queryPageSportMemberType,
    saveBatchSportMemberType,
    saveSportMemberType,
    selectSportMemberType,
} from "@/api/sport-member-type-api";
import i18n from '@/common/lang';
import UploadExcelComponent from '@/components/UploadExcel/index.vue';
import BackToTop from "@/components/BackToTop";

export default {
    name: 'SportMemberType',
        ...
        return {
            ...
            filterData: {
                ...
                decimal: [
                    {
                        ...
                        length: 8,
                        precision: 2,
                        name: i18n.t('view.sportMemberType.originalPrice'),
                    },
                    {
                        key: 'currentPrice',
                        length: 8,
                        precision: 2,
                        name: i18n.t('view.sportMemberType.currentPrice'),
                    },
                ],
                // 数字输入框
                numbers: [
                    {
                        key: 'id',
                        length: 11,
                        name: i18n.t('view.sportMemberType.id'),
                    },
                    {
                        key: 'effectiveDay',
                        length: 4,
                        name: i18n.t('view.sportMemberType.effectiveDay'),
                    },
                ],
                // 搜索输入框
                inputs: [
                    {
                        key: 'name',
                        length: 32,
                        name: i18n.t('view.sportMemberType.name'),
                    },
                    {
                        key: 'content',
                        length: 255,
                        name: i18n.t('view.sportMemberType.content'),
                    },
                    {
                        key: 'tags',
                        length: 32,
                        name: i18n.t('view.sportMemberType.tags'),
                    },
                ],
                // 搜索下拉框
                selects: [
                    {
                        key: 'discounted',
                        name: i18n.t('view.sportMemberType.discounted'),
                        options: [
                            {
                                key: '0',
                                name: i18n.t('enum.discounted.0'),
                            },
                            {
                                key: '1',
                                name: i18n.t('enum.discounted.1'),
                            },
                        ]
                    },
                    {
                        key: 'state',
                        name: i18n.t('view.sportMemberType.state'),
                        options: [
                            {
                                key: '0',
                    ...
                    {
                        key: 'creUserId',
                        name: i18n.t('view.sportMemberType.creUserName'),
                        dataSelect: {
                            url: 'sys-user',
                        },
                    },
                    {
                        key: 'updUserId',
                        name: i18n.t('view.sportMemberType.updUserName'),
                        dataSelect: {
                            url: 'sys-user',
                        },
                    },
                ...
                dateTimePickers: [
                    {
                        key: 'creTime',
                        name: i18n.t('view.sportMemberType.creTime'),
                    },
                    {
                        key: 'updTime',
                        name: i18n.t('view.sportMemberType.updTime'),
                    },
                ],
            },
            ...
            dataSource: {
                ...
                columns: [
                    {
                        key: 'id',
                        label: i18n.t('view.sportMemberType.id'),
                        sortable: true,
                    },
                    {
                        key: 'name',
                        label: i18n.t('view.sportMemberType.name'),
                        sortable: true,
                    },
                    {
                        key: 'content',
                        label: i18n.t('view.sportMemberType.content'),
                        sortable: true,
                    },
                    {
                        key: 'effectiveDay',
                        label: i18n.t('view.sportMemberType.effectiveDay'),
                        sortable: true,
                    },
                    {
                        key: 'discounted',
                        label: i18n.t('view.sportMemberType.discounted'),
                        sortable: true,
                        isSpecial: function (value) {
                            switch (value) {
                                case "0":
                                    return i18n.t('enum.discounted.0');
                                case "1":
                                    return i18n.t('enum.discounted.1');
                                default:
                    ...
                    {
                        key: 'tags',
                        label: i18n.t('view.sportMemberType.tags'),
                        sortable: true,
                    },
                    {
                        key: 'originalPrice',
                        label: i18n.t('view.sportMemberType.originalPrice'),
                        sortable: true,
                    },
                    {
                        key: 'currentPrice',
                        label: i18n.t('view.sportMemberType.currentPrice'),
                        sortable: true,
                    },
                    {
                        key: 'state',
                        label: i18n.t('view.sportMemberType.state'),
                        sortable: true,
                        isSpecial: function (value) {
                            switch (value) {
                                case "0":
                    ...
                    {
                        key: 'creUserId',
                        label: i18n.t('view.sportMemberType.creUserId'),
                        sortable: true,
                    },
                    {
                        key: 'creUserName',
                        label: i18n.t('view.sportMemberType.creUserName'),
                        sortable: true,
                    },
                    {
                        width: 160,
                        key: 'creTime',
                        label: i18n.t('view.sportMemberType.creTime'),
                        sortable: true,
                    },
                    {
                        key: 'updUserId',
                        label: i18n.t('view.sportMemberType.updUserId'),
                        sortable: true,
                    },
                    {
                        key: 'updUserName',
                        label: i18n.t('view.sportMemberType.updUserName'),
                        sortable: true,
                    },
                    {
                        width: 160,
                        key: 'updTime',
                        label: i18n.t('view.sportMemberType.updTime'),
                        sortable: true,
                    },
                ],
                // 表格数据
                    ...
                    data: [
                        {
                            ...
                            handleRowClick: (index, row) => {
                                selectSportMemberType({id: row.id}).then((res) => {
                        ...
                        },
                        {
                            ...
                            handleRowClick: (index, row) => {
                                this.$confirm(i18n.t('common.messageBox.delete.title') + row.name, i18n.t('common.messageBox.tips'), {
                                    ...
                                    // 确定
                                    deleteSportMemberType({id: row.id}).then((res) => {
                                        if (res.data) {
                                            this.queryPage()
            ...
            infoDialogData: {
                ...
                modelItem: [
                    ...
                    },
                    {
                        ...
                        length: 11,
                        key: 'creUserId',
                        name: i18n.t('view.sportMemberType.creUserId'),
                    },
                    {
                        type: 'input',
                        length: 10,
                    ...
                    },
                    {
                        ...
                        length: 11,
                        key: 'updUserId',
                        name: i18n.t('view.sportMemberType.updUserId'),
                    },
                    {
                        type: 'input',
                        length: 10,
    ...
    methods: {
        ...
        modify(data) {
            this.$confirm(i18n.t('common.messageBox.modify.title'), i18n.t('common.messageBox.tips'), {
                ...
                saveSportMemberType(data).then((res) => {
                    if (res.data) {
                        this.$message.success(i18n.t('common.success'));
        ...
        async queryPage() {
            ...
            try {
                ...
                const res = await queryPageSportMemberType({...pagination, ...sort, ...this.filterData.listQuery});
        ...
        batchAdd() {
            try {
                saveBatchSportMemberType(this.batchDialogData.excelData.file).then((res) => {
                    if (res.data) {
                        this.queryPage();
                        this.$message.success(i18n.t('common.success'));
        ...
        batchDelete() {
            this.$confirm(i18n.t('common.messageBox.batchDelete.title'), i18n.t('common.messageBox.tips'), {
                ...
                // 确定
                deleteBatchSportMemberType(this.selected).then((res) => {
                    if (res.data) {
                        this.queryPage()
                        this.$message.success(i18n.t('common.success'));
                    } else {
        ...
        batchExport(key) {
            ...
            switch (key) {
                ...
                case EXPORT_TYPE.CHOOSE: {
                    ...
                    hasSelected ? exportChoseExcelSportMemberType(this.selected) : this.$message.error(EXPORT_CHOOSE_NULL_ERROR_MSG);
                    break;
                }
                case EXPORT_TYPE.QUERY:
                    this.$message.success(EXPORT_SUCCESS_MSG);
                    exportParamExcelSportMemberType({...this.filterData.listQuery});
                    break;
