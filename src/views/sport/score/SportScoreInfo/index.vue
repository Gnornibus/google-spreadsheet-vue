...
import {
    deleteBatchSportScoreInfo,
    deleteSportScoreInfo,
    exportChoseExcelSportScoreInfo,
    exportExcelSportScoreInfo,
    exportParamExcelSportScoreInfo,
    exportTemplateSportScoreInfo,
    queryPageSportScoreInfo,
    saveBatchSportScoreInfo,
    saveSportScoreInfo,
    selectSportScoreInfo,
} from "@/api/sport-score-info-api";
        ...
        return {
            ...
            filterData: {
                ...
                numbers: [
                    {
                        key: 'id',
                        length: 11,
                        name: i18n.t('view.sportScoreInfo.id'),
                    },
                    {
                        key: 'projectId',
                        length: 11,
                        name: i18n.t('view.sportScoreInfo.projectId'),
                    },
                    {
                        key: 'creUserId',
                        length: 11,
                        name: i18n.t('view.sportScoreInfo.creUserId'),
                    },
                    {
                        key: 'updUserId',
                        length: 11,
                        name: i18n.t('view.sportScoreInfo.updUserId'),
                    },
                ],
                // 搜索输入框
                inputs: [
                    {
                        key: 'result',
                        length: 255,
                        name: i18n.t('view.sportScoreInfo.result'),
                    },
                    {
                        key: 'score',
                        length: 64,
                        name: i18n.t('view.sportScoreInfo.score'),
                    },
                    {
                        key: 'creUserName',
                        length: 10,
                        name: i18n.t('view.sportScoreInfo.creUserName'),
                    },
                    {
                        key: 'updUserName',
                        length: 10,
                        name: i18n.t('view.sportScoreInfo.updUserName'),
                    },
                ],
                // 搜索下拉框
                selects: [
                    {
                        key: 'state',
                        name: i18n.t('view.sportScoreInfo.state'),
                        options: [
                            {
                                key: '0',
                ...
                dateTimePickers: [
                    {
                        key: 'creTime',
                        name: i18n.t('view.sportScoreInfo.creTime'),
                    },
                    {
                        key: 'updTime',
                        name: i18n.t('view.sportScoreInfo.updTime'),
                    },
                ],
            },
            ...
            dataSource: {
                ...
                columns: [
                    {
                        key: 'id',
                        label: i18n.t('view.sportScoreInfo.id'),
                        sortable: true,
                    },
                    {
                        key: 'result',
                        label: i18n.t('view.sportScoreInfo.result'),
                        sortable: true,
                    },
                    {
                        key: 'projectId',
                        label: i18n.t('view.sportScoreInfo.projectId'),
                        sortable: true,
                    },
                    {
                        key: 'score',
                        label: i18n.t('view.sportScoreInfo.score'),
                        sortable: true,
                    },
                    {
                        key: 'state',
                        label: i18n.t('view.sportScoreInfo.state'),
                        sortable: true,
                    ...
                    {
                        key: 'creUserId',
                        label: i18n.t('view.sportScoreInfo.creUserId'),
                        sortable: true,
                    },
                    {
                        key: 'creUserName',
                        label: i18n.t('view.sportScoreInfo.creUserName'),
                        sortable: true,
                    },
                    {
                        width: 160,
                        key: 'creTime',
                        label: i18n.t('view.sportScoreInfo.creTime'),
                        sortable: true,
                    },
                    {
                        key: 'updUserId',
                        label: i18n.t('view.sportScoreInfo.updUserId'),
                        sortable: true,
                    },
                    {
                        key: 'updUserName',
                        label: i18n.t('view.sportScoreInfo.updUserName'),
                        sortable: true,
                    },
                    {
                        width: 160,
                        key: 'updTime',
                        label: i18n.t('view.sportScoreInfo.updTime'),
                        sortable: true,
                    },
                ],
                // 表格数据
                    ...
                    data: [
                        {
                            ...
                            handleRowClick: (index, row) => {
                                selectSportScoreInfo({id: row.id}).then((res) => {
                        ...
                        },
                        {
                            ...
                            handleRowClick: (index, row) => {
                                this.$confirm(i18n.t('common.messageBox.delete.title') + row.name, i18n.t('common.messageBox.tips'), {
                                    ...
                                    // 确定
                                    deleteSportScoreInfo({id: row.id}).then((res) => {
                                        if (res.data) {
                                            this.queryPage()
    ...
    methods: {
        ...
        modify(data) {
            this.$confirm(i18n.t('common.messageBox.modify.title'), i18n.t('common.messageBox.tips'), {
                ...
                saveSportScoreInfo(data).then((res) => {
                    if (res.data) {
                        this.$message.success(i18n.t('common.success'));
        ...
        async queryPage() {
            ...
            try {
                ...
                const res = await queryPageSportScoreInfo({...pagination, ...sort, ...this.filterData.listQuery});
        ...
        batchAdd() {
            try {
                saveBatchSportScoreInfo(this.batchDialogData.excelData.file).then((res) => {
                    if (res.data) {
                        this.queryPage();
                        this.$message.success(i18n.t('common.success'));
        ...
        batchDelete() {
            this.$confirm(i18n.t('common.messageBox.batchDelete.title'), i18n.t('common.messageBox.tips'), {
                ...
                // 确定
                deleteBatchSportScoreInfo(this.selected).then((res) => {
                    if (res.data) {
                        this.queryPage()
                        this.$message.success(i18n.t('common.success'));
                    } else {
        ...
        batchExport(key) {
            ...
            switch (key) {
                ...
                case EXPORT_TYPE.CHOOSE: {
                    ...
                    hasSelected ? exportChoseExcelSportScoreInfo(this.selected) : this.$message.error(EXPORT_CHOOSE_NULL_ERROR_MSG);
                    break;
                }
                case EXPORT_TYPE.QUERY:
                    this.$message.success(EXPORT_SUCCESS_MSG);
                    exportParamExcelSportScoreInfo({...this.filterData.listQuery});
                    break;
