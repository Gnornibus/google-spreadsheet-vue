...
import {
    deleteBatchSportScoreRange,
    deleteSportScoreRange,
    exportChoseExcelSportScoreRange,
    exportExcelSportScoreRange,
    exportParamExcelSportScoreRange,
    exportTemplateSportScoreRange,
    queryPageSportScoreRange,
    saveBatchSportScoreRange,
    saveSportScoreRange,
    selectSportScoreRange,
} from "@/api/sport-score-range-api";
import i18n from '@/common/lang';
import UploadExcelComponent from '@/components/UploadExcel/index.vue';
import BackToTop from "@/components/BackToTop";

export default {
    name: 'SportScoreRange',
        ...
        return {
            ...
            filterData: {
                ...
                decimal: [
                    {
                        ...
                        length: 8,
                        precision: 2,
                        name: i18n.t('view.sportScoreRange.point'),
                    },
                    {
                        key: 'score',
                        length: 8,
                        precision: 2,
                        name: i18n.t('view.sportScoreRange.score'),
                    },
                ],
                // 数字输入框
                numbers: [
                    {
                        key: 'id',
                        length: 11,
                        name: i18n.t('view.sportScoreRange.id'),
                    },
                    {
                        key: 'projectId',
                        length: 11,
                        name: i18n.t('view.sportScoreRange.projectId'),
                    },
                    {
                        key: 'creUserId',
                        length: 11,
                        name: i18n.t('view.sportScoreRange.creUserId'),
                    },
                    {
                        key: 'updUserId',
                        length: 11,
                        name: i18n.t('view.sportScoreRange.updUserId'),
                    },
                ],
                // 搜索输入框
                inputs: [
                    {
                        key: 'creUserName',
                        length: 10,
                        name: i18n.t('view.sportScoreRange.creUserName'),
                    },
                    {
                        key: 'updUserName',
                        length: 10,
                        name: i18n.t('view.sportScoreRange.updUserName'),
                    },
                ],
                // 搜索下拉框
                selects: [
                    {
                        key: 'sex',
                        name: i18n.t('view.sportScoreRange.sex'),
                        options: [
                            {
                                key: '0',
                    ...
                    {
                        key: 'state',
                        name: i18n.t('view.sportScoreRange.state'),
                        options: [
                            {
                                key: '0',
                ...
                dateTimePickers: [
                    {
                        key: 'creTime',
                        name: i18n.t('view.sportScoreRange.creTime'),
                    },
                    {
                        key: 'updTime',
                        name: i18n.t('view.sportScoreRange.updTime'),
                    },
                ],
            },
            ...
            dataSource: {
                ...
                columns: [
                    {
                        key: 'id',
                        label: i18n.t('view.sportScoreRange.id'),
                        sortable: true,
                    },
                    {
                        key: 'projectId',
                        label: i18n.t('view.sportScoreRange.projectId'),
                        sortable: true,
                    },
                    {
                        key: 'sex',
                        label: i18n.t('view.sportScoreRange.sex'),
                        sortable: true,
                    ...
                    {
                        key: 'point',
                        label: i18n.t('view.sportScoreRange.point'),
                        sortable: true,
                    },
                    {
                        key: 'score',
                        label: i18n.t('view.sportScoreRange.score'),
                        sortable: true,
                    },
                    {
                        key: 'state',
                        label: i18n.t('view.sportScoreRange.state'),
                        sortable: true,
                        isSpecial: function (value) {
                            switch (value) {
                                case "0":
                    ...
                    {
                        key: 'creUserId',
                        label: i18n.t('view.sportScoreRange.creUserId'),
                        sortable: true,
                    },
                    {
                        key: 'creUserName',
                        label: i18n.t('view.sportScoreRange.creUserName'),
                        sortable: true,
                    },
                    {
                        width: 160,
                        key: 'creTime',
                        label: i18n.t('view.sportScoreRange.creTime'),
                        sortable: true,
                    },
                    {
                        key: 'updUserId',
                        label: i18n.t('view.sportScoreRange.updUserId'),
                        sortable: true,
                    },
                    {
                        key: 'updUserName',
                        label: i18n.t('view.sportScoreRange.updUserName'),
                        sortable: true,
                    },
                    {
                        width: 160,
                        key: 'updTime',
                        label: i18n.t('view.sportScoreRange.updTime'),
                        sortable: true,
                    },
                ],
                // 表格数据
                    ...
                    data: [
                        {
                            ...
                            handleRowClick: (index, row) => {
                                selectSportScoreRange({id: row.id}).then((res) => {
                        ...
                        },
                        {
                            ...
                            handleRowClick: (index, row) => {
                                this.$confirm(i18n.t('common.messageBox.delete.title') + row.name, i18n.t('common.messageBox.tips'), {
                                    ...
                                    // 确定
                                    deleteSportScoreRange({id: row.id}).then((res) => {
                                        if (res.data) {
                                            this.queryPage()
    ...
    methods: {
        ...
        modify(data) {
            this.$confirm(i18n.t('common.messageBox.modify.title'), i18n.t('common.messageBox.tips'), {
                ...
                saveSportScoreRange(data).then((res) => {
                    if (res.data) {
                        this.$message.success(i18n.t('common.success'));
        ...
        async queryPage() {
            ...
            try {
                ...
                const res = await queryPageSportScoreRange({...pagination, ...sort, ...this.filterData.listQuery});
        ...
        batchAdd() {
            try {
                saveBatchSportScoreRange(this.batchDialogData.excelData.file).then((res) => {
                    if (res.data) {
                        this.queryPage();
                        this.$message.success(i18n.t('common.success'));
        ...
        batchDelete() {
            this.$confirm(i18n.t('common.messageBox.batchDelete.title'), i18n.t('common.messageBox.tips'), {
                ...
                // 确定
                deleteBatchSportScoreRange(this.selected).then((res) => {
                    if (res.data) {
                        this.queryPage()
                        this.$message.success(i18n.t('common.success'));
                    } else {
        ...
        batchExport(key) {
            ...
            switch (key) {
                ...
                case EXPORT_TYPE.CHOOSE: {
                    ...
                    hasSelected ? exportChoseExcelSportScoreRange(this.selected) : this.$message.error(EXPORT_CHOOSE_NULL_ERROR_MSG);
                    break;
                }
                case EXPORT_TYPE.QUERY:
                    this.$message.success(EXPORT_SUCCESS_MSG);
                    exportParamExcelSportScoreRange({...this.filterData.listQuery});
                    break;
